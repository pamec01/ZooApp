...
export default function AddSuchozemske() {
    ...
    const loadZvire = async () => {
        const resultNotSuchoVodni = await axios.get(ZvireConstants.apiSelectAllNotSuchoVodniUrl);

        const choices = resultNotSuchoVodni.data.map((zvire) => getSelectObjectFromEntity(zvire));
