...
export default function ZvireKrmeni() {
    ...
    const deleteEntityId = async (zvireId, krmeniId) => {
        await axios.delete(Constants.apiDeleteUrl(zvireId, krmeniId))
    ...
    const DeleteButton = (tableRow) =>
        <button className="btn btn-danger mx-2"
                onClick={() => deleteEntityId(tableRow.original.zvireKrmeniId)}
        >
            Odstranit
        </button>;
